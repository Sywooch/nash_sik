...
$(window).on("load",function(){var e=$("#page-preloader");e.find(".slogan").fadeOut(),e.delay(800).fadeOut("slow")}),$(function(){$(".head-slider").slick({infinite:!0,arrows:!1,dots:!0,slidesToShow:1,slidesToScroll:1,verticalSwiping:!0,fade:!0,speed:1e3,cssEase:"linear",autoplay:!0,autoplaySpeed:3e3,pauseOnHover:!1}),$(".story-slider").slick({infinite:!0,arrows:!0,dots:!0,slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:5e3}),$("a[href*='#']").mPageScroll2id(),$(".menu-open").click(function(){$(".main-nav").stop().slideToggle(250)});var e={offset:1e3};new Headhesive(".main-header",e)});